...
*/
var Invitee = ['Zayghum', 'Eric', 'Jhonson', 'mutahir'];
console.log(Invitee);
Invitee.splice(0, 0, 'ali akber');
console.log(Invitee);
var index_count = Invitee.length / 2;
...
for (var remove_guest = 0; remove_guest <= Invitee.length; remove_guest++) {
    console.log("We are sorry ".concat(Invitee[remove_guest], ", we can't invite you to dinner"), Invitee.pop());
}
for (var a = 0; a < Invitee.length; a++) {
    console.log("\n ".concat(Invitee[a], " you are still invited"));
}
console.log("There a ".concat(Invitee.length, " numbers of people to be invited in the dinner"));
